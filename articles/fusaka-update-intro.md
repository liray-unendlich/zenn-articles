...
Fusaka アップグレードは、Ethereum のスケーラビリティにおいて非常に大きなハードフォークです。特に大きなものとして、 PeerDAS が取り上げられることが多いですが、上で各ステークホルダーへの影響を記載したように、細かな UX 改善も数多く含まれています。また、将来的な TPS 拡大、Preconfirmation 等を通した利用者にとっての UX の改善など、未来を見据えた改善も数多く含まれています。
